	...
	<div class="row profile">
		...
		<div class="col-md-8 profile_left">
			...
			<div class="profile_com profile_first_name">First Name:
				...
				<a href="{{ url('#') }}" id="first_name" data-pk={{Auth::guard('adProvider')->user()->id }}>{{ ($profile_info->first_name) ? $profile_info->first_name : "Set First Name" }}
				</a>
			...
			<div class="profile_com profile_last_name">Last Name:
				...
				<a href="{{ url('#') }}" id="last_name" data-pk={{Auth::guard('adProvider')->user()->id }}>{{ ($profile_info->last_name) ? $profile_info->last_name : "Set Last Name" }}
				</a>
			...
			<div class="profile_com profile_mobile">Mobile:
				...
				<a href="{{ url('#') }}" id="mobile" data-pk={{Auth::guard('adProvider')->user()->id }}>{{ ($profile_info->mobile) ? $profile_info->mobile : "Set Mobile Number" }}
				</a>
			...
			<div class="profile_com profile_address">Address:
				...
				<a href="{{ url('#') }}" id="address" data-pk={{Auth::guard('adProvider')->user()->id }}>{{ ($profile_info->address) ? $profile_info->address : "Set Address" }}
				</a>
