...
<div class="admin_password_reset" id="container">
   ...
   <div class="passwordResetForm">
    ...
    {!! Form::open(['method' => 'POST', 'url' => '/admin/password/reset' , 'name'=> 'passwordResetForm', 'data-remote' => 'data-remote', 'data-remote-success' => 'Password Reset Successful']) !!}
