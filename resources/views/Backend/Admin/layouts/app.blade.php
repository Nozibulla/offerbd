...
<head>
    ...
    <script src="{{ asset('backend/admin/js/offerbd.login.js') }}"></script>
    ...
    <link rel="stylesheet" href="{{ asset('backend/admin/css/login/offerbd.custom.login.css') }}" type="text/css">
